...
We invite you to consult our complete sponsorship package in PDF format: <a href="{{ '../assets/pdf/Plan de commandite-ECOFLORE-ENG-rev1-03-07-2025.pdf' | relative_url }}" target="_blank"> [Download the sponsorship package]{:class="lang-switch"}</a>
